#ifndef MSCFModel_OptimalSpeed_h
#define	MSCFModel_OptimalSpeed_h
...
// class definitions
// ===========================================================================
/** @class MSCFModel_Optimalspeed
 * @brief Our new implemented model
 * @see MSCFModel
 */
class MSCFModel_OptimalSpeed : public MSCFModel {
public:
    /** @brief Constructor
    ...
    virtual int getModelID() const {
        return SUMO_TAG_CF_OPTIMALSPEED;
    }
